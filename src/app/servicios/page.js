...
const services = [
  ...
  },
  {
    ...
    description:
      'Preparamos tu declaración de impuestos federal y estatal con precisión y cuidado. Analizamos cada deducción posible para maximizar tu reembolso legalmente. Ya seas empleado, trabajador independiente (1099) o propietario de un pequeño negocio, te ayudamos a cumplir con el IRS sin estrés.',
    benefits: [
  ...
  },
  {
    ...
    description:
      'Ofrecemos preparación completa de impuestos para LLC, S-Corp, C-Corp, partnerships y otros tipos de entidades comerciales. Nuestros especialistas entienden la estructura fiscal de los negocios en Massachusetts y trabajan para minimizar tu carga tributaria dentro del marco legal.',
    benefits: [
  ...
  },
  {
    ...
    description:
      'Mantenemos la contabilidad de tu negocio organizada, actualizada y lista para cualquier revisión. Con nuestro servicio de bookkeeping mensual, sabrás exactamente cómo están tus finanzas, podrás tomar mejores decisiones y estarás preparado para la temporada de taxes sin sorpresas.',
    benefits: [
  ...
  },
  {
    ...
    description:
      'Gestionamos el proceso completo de nómina de tu empresa: cálculo de salarios, deducciones, pagos y cumplimiento de todas las obligaciones fiscales con el IRS y el estado de Massachusetts. Tú te enfocas en tu negocio, nosotros nos encargamos de que tus empleados cobren correctamente y a tiempo.',
    benefits: [
  ...
  },
  {
    ...
    description:
      'Un buen crédito abre puertas. Te ayudamos a revisar tu historial crediticio, identificar errores o elementos negativos, y desarrollar un plan personalizado para mejorar tu score de forma efectiva y sostenida. Trabajamos contigo con estrategias reales, sin promesas falsas.',
    benefits: [
      'Revisión completa de los 3 bureaus (Equifax, Experian, TransUnion)',
      'Identificación de errores e imprecisiones en tu reporte',
      'Disputa de ítems incorrectos o no verificables',
      'Estrategias para mejorar tu score a corto y largo plazo',
      'Orientación sobre hábitos de crédito saludables',
      'Seguimiento mensual de tu progreso',
    ],
    audience: 'Personas con historial crediticio bajo, deudas en colección, o que quieren mejorar su score para calificar para un préstamo, hipoteca, tarjeta de crédito o alquiler.',
  },
]
      ...
      <section className="bg-hero-gradient pt-32 pb-20 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-300 text-lg leading-relaxed max-w-2xl mx-auto">
            Soluciones completas para individuos y negocios en Boston, MA. Atención en español,
            proceso claro y resultados reales.
          </p>
        </div>
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className={`md:col-span-3 ${index % 2 !== 0 ? 'md:order-1' : ''}`}>
                ...
                <h3 className="font-bold text-navy-900 text-base mb-3">¿Qué incluye?</h3>
                ...
                <div className="bg-blue-50 border border-blue-100 rounded-xl p-5 mb-4">
                  <p className="text-sm font-semibold text-navy-900 mb-1">¿Para quién es ideal?</p>
