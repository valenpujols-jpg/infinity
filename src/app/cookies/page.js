...
export const metadata = {
  ...
  description:
    'Política de Cookies de Infinity Solutions of Roxbury LLC. / Cookie Policy — learn what cookies we use and how to manage them.',
}
    ...
    <>
      ...
      <section className="bg-hero-gradient pt-32 pb-16 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gold-300 text-lg font-medium mb-3">Cookie Policy</p>
