...
export const metadata = {
  ...
  description:
    'Política de Privacidad de Infinity Solutions of Roxbury LLC. Conoce cómo recopilamos, usamos y protegemos tu información personal. / Privacy Policy — learn how we collect, use and protect your personal information.',
}
    ...
    <>
      ...
      <section className="bg-hero-gradient pt-32 pb-16 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gold-300 text-lg font-medium mb-3">Privacy Policy</p>
