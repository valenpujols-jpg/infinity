        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-gray max-w-none">
          <div className="space-y-10 text-gray-700 text-sm leading-relaxed">
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-1.5 ml-2">
                <li>
                  <strong>Proveedores de servicios tecnológicos:</strong> Plataformas de contabilidad,
                  CRM, software de gestión de nómina u otras herramientas necesarias para prestar
                  nuestros servicios. Estos proveedores están obligados contractualmente a proteger
                  tu información.
                </li>
                <li>
                  <strong>Autoridades gubernamentales:</strong> Cuando sea requerido por ley, orden
                  judicial o agencias regulatorias como el IRS o el Departamento de Trabajo.
                </li>
                <li>
                  <strong>Con tu consentimiento expreso:</strong> Para cualquier otro propósito que
                  requiera compartir tu información con terceros no mencionados anteriormente.
                </li>
              </ul>
            </section>
            ...
            <section>
              <h2 className="text-xl font-bold text-navy-900 mb-4 pb-2 border-b border-gray-100">
                7. Tus derechos sobre tu información
              </h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-navy-900 mb-4 pb-2 border-b border-gray-100">
                8. Derechos adicionales (residentes de California — CCPA)
              </h2>
              <p>
            ...
            <div className="bg-navy-900 rounded-xl p-7 text-white">
              <h2 className="text-lg font-bold mb-3">Contacto — Privacidad</h2>
              <p className="text-gray-300 text-sm mb-4">
                Para cualquier consulta relacionada con esta Política de Privacidad o el manejo de
