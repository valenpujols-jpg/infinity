...
export const metadata = {
  title: 'Aviso Legal | Legal Disclaimer',
  description:
    'Aviso legal de Infinity Solutions of Roxbury LLC. Información crítica sobre los límites de nuestros servicios. / Legal disclaimer — important information about the scope of our services.',
}
    ...
    <>
      ...
      <section className="bg-hero-gradient pt-32 pb-16 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold text-white mb-2">Aviso Legal y Descargo de Responsabilidad</h1>
          <p className="text-gold-300 text-lg font-medium mb-3">Legal Disclaimer</p>
