...
const content = {
  es: {
    ...
    alertBody: 'Este documento contiene información legal crítica sobre los alcances y limitaciones de los servicios de Infinity Solutions of Roxbury LLC. Lee cuidadosamente antes de contratar cualquier servicio.',
    sections: [
      {
      ...
      },
      {
        ...
        body: (
          <div className="space-y-3 text-red-900 text-sm">
            <p><strong>Infinity Solutions of Roxbury LLC NO es una firma de abogados y NO proporciona asesoría legal de inmigración.</strong></p>
      ...
      },
      {
        ...
        body: (
          <ul className="list-disc list-inside space-y-2.5 ml-2">
            ...
            <li>El cliente es <strong>exclusivamente responsable</strong> de la veracidad, exactitud y completitud de toda la información, documentación e ingresos reportados. Infinity Solutions of Roxbury LLC no se hace responsable de las consecuencias derivadas de información incorrecta, incompleta o fraudulenta proporcionada por el cliente.</li>
  ...
  en: {
    ...
    alertBody: 'This document contains critical legal information about the scope and limitations of Infinity Solutions of Roxbury LLC services. Please read carefully before engaging any service.',
    sections: [
      {
        ...
        body: (
          <>
            ...
            <p className="mt-3">Infinity Solutions of Roxbury LLC is a professional document preparation and administrative consulting company. We are not attorneys, Certified Public Accountants (CPAs) in all areas, or legal representatives. The information provided on this site does not replace consultation with a licensed professional in the specific area you require.</p>
          </>
        ),
      },
      {
        ...
        body: (
          <div className="space-y-3 text-red-900 text-sm">
            <p><strong>Infinity Solutions of Roxbury LLC is NOT a law firm and does NOT provide immigration legal advice.</strong></p>
      ...
      },
      {
        ...
        body: (
          <ul className="list-disc list-inside space-y-2.5 ml-2">
            ...
            <li>The client is <strong>solely responsible</strong> for the truthfulness, accuracy, and completeness of all information, documentation, and income reported. Infinity Solutions of Roxbury LLC is not responsible for consequences arising from incorrect, incomplete, or fraudulent information provided by the client.</li>
