...
const data = {
  es: {
    ...
    missionBody: 'Brindar servicios financieros, contables y migratorios de la más alta calidad a individuos y empresas, especialmente a la comunidad hispana en Boston, MA. Nos comprometemos a ofrecer atención personalizada, clara y confiable, eliminando barreras y acompañando a nuestros clientes hacia su bienestar y estabilidad.',
