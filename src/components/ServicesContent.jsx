  ...
  es: {
    ...
    services: [
      ...
      },
      {
        ...
        icon: creditIcon,
        description: 'Un buen crédito abre puertas. Te ayudamos a revisar tu historial crediticio, identificar errores o elementos negativos, y desarrollar un plan personalizado para mejorar tu score de forma efectiva y sostenida. Trabajamos contigo con estrategias reales, sin promesas falsas.',
        benefits: [
  ...
  en: {
    ...
    services: [
      ...
      },
      {
        ...
        title: 'Credit Repair',
        icon: creditIcon,
        description: 'Good credit opens doors. We help you review your credit history, identify errors or negative items, and develop a personalized plan to improve your score effectively and sustainably. We work with you using real strategies, without false promises.',
        benefits: [
          'Full review of all 3 bureaus (Equifax, Experian, TransUnion)',
          'Identification of errors and inaccuracies in your report',
          'Dispute of incorrect or unverifiable items',
          'Strategies to improve your score short and long term',
          'Guidance on healthy credit habits',
          'Monthly progress tracking',
        ],
        audience: 'People with low credit history, collections debts, or who want to improve their score to qualify for a loan, mortgage, credit card or rental.',
      },
    ],
  },
}
